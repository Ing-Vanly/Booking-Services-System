                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <h3 class="card-title">{{ __('Product Calendar List') }}</h3>
                                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form_modal_calendar  " novalidate onsubmit="return false">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6" style="margin-bottom: 7px;">
                                    <div class="form-group">
                                        ...
                                        <div class="onoffswitch4">
                                            <input type="checkbox" name="onoffswitch4" true-value=1 false-value=0
                                                class="onoffswitch4-checkbox available_toggle" id="myonoffswitch4"
                                ...
                                <div class="col-md-12 number_div" v-show="form.is_active">
                                    <div class="row">
                                        <div class="col-md-4 price_div">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>{{ __('Available products') }}</label>
                                                <input type="number" v-model="form.total_number" class="form-control"
                                                    min="0" readonly>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal"><i
                                class="fa fa-times-circle"></i> {{ __('Close') }}</button>
                        <button type="button" class="btn btn-primary" @click="saveForm"><i class="fa fa-pencil-alt"></i>
                            {{ __('Save') }}</button>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function(e) {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                firstDay: 1,
                events: {
                    url: "{{ route('admin.booking.loaddate') }}",
                    extraParams: {
                        // id:lastId,
                ...
                select: function(arg) {
                    formModal.show({
                        ...
                        end_date: moment(arg.start).format('MM/DD/YYYY'),
                    });
                },
        ...
        @if (request('product_id'))
            $(`.product_{{ request('product_id') }} a`).trigger('click');
        @else
        ...
        formModal = new Vue({
            ...
            methods: {
                ...
                saveForm: function() {
                    this.form.target_id = `{{ request('product_id') }}`;
                    var me = this;
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.success == 1) {
                                ...
                                me.hide();
                                toastr.success(response.msg); // Success message
                            } else {
                                toastr.error(response.msg); // Error message
                            }
                        ...
                        error: function(e) {
                            me.onSubmit = false;
                            toastr.error(
                                'An error occurred'); // General error message for AJAX failure
                        }
                    });
                },
