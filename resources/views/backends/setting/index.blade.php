                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-6 col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="company_address" id="company_address" class="form-control" value="{{ $company_address }}">
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-6 col-md-4">
                                                    <div class="form-group">
                                                        <label for="copy_right_text">{{ __('Copyright Text') }}</label>
                                                        <input type="text" name="copy_right_text" id="copy_right_text" class="form-control" value="{{ $copy_right_text }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="preview">
                                                            <img src="
                                                            @if ($fav_icon && file_exists('uploads/business_settings/'. $fav_icon))
                                                                {{ asset('uploads/business_settings/'. $fav_icon) }}
                                                            @else
                                                                {{ asset('images/no_image_available.jpg') }}
                                                            @endif
                                                            " alt="" height="120px">
