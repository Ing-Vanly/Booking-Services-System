                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="discount_type" id="discount_type" class="form-control">
                                            <option value="percent"
                                                ...
                                                {{ __('Percent') }}</option>
                                            <option value="fix"
                                                {{ $product->discount_type == 'fix' ? 'selected' : '' }}>
                                                {{ __('Fix') }}</option>
                                        </select>
                                        @error('discount_type')
                                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="event_id" id="event_id"
                                            ...
                                            value="{{ old('event_id', $product->event_id) }}">
                                        @error('event_id')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="brandCategory" id="brandCategory"
                                            ...
                                            @foreach ($brandCategories as $id => $name)
                                                <option value="{{ $id }}"
                                                    {{ $id == $product->brand_category_id ? 'selected' : '' }}>
                                                    {{ $name }}</option>
                                            @endforeach
                                        </select>
                                        @error('brandCategory')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" name="number_available" id="number_available"
                                            ...
                                            value="{{ old('number_available', $product->number_available) }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="partner_id" id="partner_id"
                                            ...
                                            value="{{ old('partner_id', $product->partner_id) }}">
                                        @error('partner_id')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
