            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-12">
                                ...
                                @if ($lang['status'] == 1)
                                    ...
                                    <div class="tab-pane fade {{ $lang['code'] == $default_lang ? 'show active' : '' }}" id="lang_{{ $lang['code'] }}" role="tabpanel" aria-labelledby="lang_{{ $lang['code'] }}-tab">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name[]" id="name_{{ $lang['code'] }}" class="form-control" value="{{ $translate[$lang['code']]['name']??$category['name'] }}" {{ $lang['code'] == 'en' ? 'required' : '' }}>
                                        </div>
                                    </div>
                                @endif
                            @endforeach
                        ...
                        <!-- short description -->
                        <div class="form-group">
                            <label for="short_des">{{ __('Short Description') }}</label>
                            <input type="text" name="short_des" id="short_des" class="form-control"
                                value="{{ old('short_des', $category->short_des) }}"=>
                            @error('short_des')
