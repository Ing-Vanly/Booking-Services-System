                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6">
                                    @can('slider.create')
                                    <a class="btn btn-primary btn-modal float-right" href="#" data-href="{{ route('admin.slider.create') }}" data-toggle="modal" data-container=".modal_form">
                        ...
                        @include('backends.slider._table')
                    </div>
                </div>
            </div>
        </div>
