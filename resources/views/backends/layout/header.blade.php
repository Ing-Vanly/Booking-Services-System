        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="{{ asset('uploads/users/' . (Auth::user()->image ?? 'default-profile.png')) }}" class="user-image img-circle elevation-2"
                        alt="User Image">
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
                    ...
                    <li class="user-header bg-primary">
                        <img src="{{ asset('uploads/users/' . (Auth::user()->image ?? 'default-profile.png')) }}" class="img-circle elevation-2"
                            alt="User Image">
            ...
            <li class="user-footer">
                <a href="{{ route('admin.profile.index') }}" class="btn btn-default btn-flat float-left">{{__('Profile')}}</a>
