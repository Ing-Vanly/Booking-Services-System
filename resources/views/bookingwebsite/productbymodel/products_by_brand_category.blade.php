                                        ...
                                        <div class="card-img-top position-relative overflow-hidden">
                                            ...
                                            @php
                                                ...
                                                if ($promotionProduct && $promotionProduct->discount_value > 0) {
                                                    ...
                                                    $showDiscount = true;
                                                    $discountValue = $promotionProduct->discount_value;
                                                    ...
                                                    $finalPrice = $product->price - $discountAmount;
                                                    $showDiscount = true;
                                                    $discountValue = $promotionCategory->discount_value;
                                            ...
                                            @endphp
                                            @if ($showDiscount)
                                                <span class="badge badge-danger position-absolute" style="top: 10px; left: 10px; font-size: 14px; padding: 5px 10px;">
                                                    -{{ $discountValue }}%
                                                </span>
                                            @endif
                                        </div>
