        ...
        <div class="center-column">
            <div class="space-4">
                <div class="row">
                    ...
                    <!-- Adjusted filter column width to col-md-4 -->
                    <div class="col-md-6 mb-4">
                                ...
                                <form id="productForm" method="POST">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="qty" id="qty" class="form-control" oninput="calculateTotal()" required>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="mb-3 d-flex justify-content-end btn-group">
                                        <button type="button" class="btn btn-primary btn-custom" onclick="submitForm('cart.checkAvailability')">{{__('Add to Cart')}}</button>
                                        <button type="button" class="btn btn-success btn-custom" onclick="submitForm('cart.checkBookingAvailability')">{{__('Booking')}}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
